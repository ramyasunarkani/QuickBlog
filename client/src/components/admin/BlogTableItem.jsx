  ...
  return (
   <tr className='border-y border-gray-300'>
    ...
    <td className='px-2 py-4 max-sm:hidden'>
           <p className={`${blog.isPublished?"text-green-800":"text-orange-800"}`}>
    ...
    <td className='px-2 py-4 flex text-xs gap-3'>
        ...
        <img onClick={deleteBlog} className='w-8 hover:scale-110 transition-all' src={assets.cross_icon} alt="" />
    </td>
   </tr>
  )
}

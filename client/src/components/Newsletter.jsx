...
const Newsletter = () => {
  return (
    <div className='flex flex-col justify-center items-center space-y-2 my-32'>
       ...
       <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
         <input type="text" placeholder='Enter your email id' className='border border-gray-300 rounded-md h-full border-radius-0 outline-none w-full rounded-r-none px-3 text-gray-500' required />

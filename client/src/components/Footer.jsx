      ...
      <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/3 text-gray-500'>
        ...
        <div>
            ...
            <p className='max-w-[410px] mt-6'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum quas soluta esse sunt ex explicabo aut. Qui aspernatur, porro atque magni ipsum  
            </p>
        </div>
                        ...
                        <ul className='text-sm space-y-1'>
                            {
                                section.links.map((link,i)=>(
                                    <li key={i}>
                                        <a className="hover:underline" href="#">{link}</a>
                                    </li>
                                ))
                            }
                        </ul>

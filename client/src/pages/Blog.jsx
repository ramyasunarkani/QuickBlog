...
import { assets, comments_data } from '../assets/QuickBlog-Assets/assets';
  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>Vidya Telugu</p>
      </div>

      <div className='mx-5 max-w-5xl md:mx-auto  my-10 mt-6'>
         <img src={data.image} alt="" className='rounded-3xl mb-5'/>

         <div className="rich-text md:w-3xl mx-auto" dangerouslySetInnerHTML={{__html:data.description}}>
          {data.desc}
         </div>
         ...
         <div>
             ...
             <div className='my-24 max-w-3xl mx-auto'>
              ...
              <div className='flex'>
                 ...
                 <img className='text-white' src={assets.googleplus_icon} width={50}  alt="" />
              </div>
             </div>
         </div>
      </div>

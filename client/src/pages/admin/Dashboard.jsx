...
const Dashboard=()=>{
    ...
    return (
        <div className="flex-1 p-4 md:p-10 bg-blue-50/50">
            ...
            <div>
                <div className="flex items-center m-4 mt-6 text-gray-600 gap-3">
                ...
                <div className="relative max-w-4xl overflow-x-auto shadow rounded-lg scrollbar-hide bg-white">
                    <table className="w-full text-sm text-gray-500">
                        <thead className="w-full text-sm text-gray-500 text-left uppercase">
                           <tr>
                         ...
                         <tbody>
                           {
                            dashboardData.recentBlogs.map((blog,index)=>(
                                <BlogTableItem key={blog._id} blog={blog} fetchBlogs={fetchDashboard}
                                index={index+1}/>
                            ))
                           }
                         </tbody>

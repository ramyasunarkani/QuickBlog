  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>    
               <div className='flex justify-between items-center max-w-3xl'>
                  <h1 className='font-semibold text-gray-700'>Comments</h1>
               ...
               <div className='relative h-4/5 max-w-3xl overflow-x-auto mt-4 bbg-white shadow rounded-lg scrollbar-hide'>
                         ...
                         <tbody>
                             {
                              comments.filter((comment)=>{
                                ...
                                return <CommentTableItem key={comment._id} index={index+1} fetchComment={fetchComments}  comment={comment}/>
                              })
                             }
                         </tbody>
                   </table>
